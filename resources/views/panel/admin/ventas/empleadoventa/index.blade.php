                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <a href="{{ route('detalle_ventaempleado.index', $venta->id) }}"
                                                ...
                                                @if (in_array($venta->estado, [1, 2]))
                                                    <a href="{{ route('ventas.empleadoventa.edit', $venta) }}"
                                                        title="Editar"
                                                        class="btn btn-sm btn-secondary text-white text-uppercase me-1 mr-2">
