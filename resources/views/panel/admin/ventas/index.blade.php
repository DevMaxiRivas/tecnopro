                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endif --}}
                                        ...
                                        @if ($ventas->estado != 4)
                                        <form id="cancel-form-{{ $ventas->id }}" action="{{ route('ventas.cancelar', $ventas->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('PATCH')
                                            <button id="cancel-button-{{ $ventas->id }}" type="button" class="btn btn-sm btn-secondary text-white text-uppercase me-1" title="Cancelar pedido">
                                                <i class="fas fa-times" aria-hidden="true"></i>
                                            </button>
                                        </form>
                                     @endif
