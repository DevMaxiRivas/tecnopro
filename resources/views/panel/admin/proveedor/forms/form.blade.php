             ...
             <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control @error('razon_social') is-invalid @enderror"
                        ...
                        value="{{ old('razon_social', optional($proveedor)->razon_social) }}" readonly>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control @error('cuit') is-invalid @enderror"
                        id="cuit" name="cuit"
                        value="{{ old('cuit', optional($proveedor)->cuit) }}" readonly>
           ...
           <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <select class="form-control @error('activo') is-invalid @enderror" name="activo" id="activo">
                        <option value="1" @if ($proveedor->activo) {{ 'selected' }} @endif>Activado
                        </option>
                        <option value="0" @if (isset($proveedor->activo) && !$proveedor->activo) {{ 'selected' }} @endif>Desactivado
                        </option>
                    </select>
                    @error('activo')
                        <div class="invalid-feedback"> {{ $message }} </div>
