        ...
        <div class="row">
            ...
            <div class="col-lg-10 col-md-12 col-sm-12 col-12">
                <div class="row pt-4">
                    {{-- Breadcrumbs --}}
                    <div class="container-fluid">
                        <h1> Productos Filtrados por Precio</h1>
                        ...
                        @foreach ($productos as $producto)
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-6" style="text-align: -webkit-center;">
                                <a href="{{ route('MandarDatosProductoEspecifico', $producto->id) }}"
                                    ...
                                    <div class="card element-box m-2 producto-card zoom-shadow"
                                        style="min-width: 13rem; max-width: 14rem;">
                                        <div class="container mt-3 bg-white rounded-4 inner"
            ...
            @endforeach
        @else
            <h4 class="text-info" style="margin:100px auto;"> No hay productos disponibles. </h4>
            @endif
        </div>
